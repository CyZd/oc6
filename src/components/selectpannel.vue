<template>
  <div>
    <div class="container is-fluid" id="sliderContainer">
      ...
      <input
        id="distSlider"
        v-on:click="getRangeValue"
        name="distance"
        class="slider is-fullwidth is-info is-medium is-circle"
        step="100"
        min="100"
        max="300"
        value="100"
    ...
    return {
      ...
      buttonTransport: [
        ...
        },
        {
          ...
          color: "#BE3D62",
          labels: "Recharge V.E.",
          method: "showTransportElectriccar"
        },
        {
          category: "Transport",
          name: "Stationnement",
      ...
      buttonMedic: [
        // {category:'Santé',name:'Medecins',value:false,color:'#BE3D62',labels:'Médecins',method:'showMedicMedecin'},
        {
          ...
          color: "#BE3D62",
          labels: "Pharmacies",
          method: "showMedicPharmacies"
        },
        {
          category: "Santé",
          name: "Centres de soin",
          value: false,
          color: "#BE3D62",
          labels: "Centres de soin",
          method: "showMedicCentresSante"
        }
      ],
      buttonKids: [
        {
      ...
      buttonEveryday: [
        ...
        },
        {
          ...
          value: false,
          color: "#BE3D62",
          labels: "Action sociale",
          method: "showSocialAction"
        },
        {
          category: "Quotidien",
          name: "Sport",
